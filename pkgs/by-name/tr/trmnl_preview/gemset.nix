{
  ...
  pathname = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "12gfpry1mwjyzn46gy4i614qx0cixpwf93khazq6fmnk9pazkgnq";
      type = "gem";
    };
    version = "0.4.0";
  };
  ...
  puppeteer-ruby = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "15arxff6z4l9aikzdvvbira0kc5x43l0b8z1k9q8lrgqyssgg1nb";
      type = "gem";
    };
    version = "0.45.6";
  };
  ...
  trmnl-liquid = {
    dependencies = ["actionview" "liquid" "redcarpet"];
    groups = ["default"];
    platforms = [];
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "0475cl7icxprqa4gpjv7w4d3njhsd6scrgrs34c05xlrqwhwb6i7";
      type = "gem";
    };
    version = "0.2.1";
  };
  trmnl_preview = {
    dependencies = ["activesupport" "faraday" "faraday-multipart" "faye-websocket" "filewatcher" "mini_magick" "oj" "pathname" "puma" "puppeteer-ruby" "rackup" "rexml" "rubyzip" "sinatra" "thor" "trmnl-liquid" "tzinfo-data" "xdg"];
    groups = ["default"];
    platforms = [];
    source = {
      path = ./.;
  ...
  xdg = {
    ...
    source = {
      remotes = ["https://rubygems.org"];
      sha256 = "09az7wb02jyvkij1x5qyvpwyalnanqdgjl8v1dscvszfpxc3k6ws";
      type = "gem";
    };
    version = "9.1.0";
  };
